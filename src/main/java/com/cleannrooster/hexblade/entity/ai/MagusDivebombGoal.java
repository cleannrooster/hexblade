...
public class MagusDivebombGoal<E extends Magus> extends Goal{
    ...
    public void tick() {
        ...
        if(this.mob.isOnGround()){
            this.triggered = true;
            Spell spell = SpellRegistry.getSpell(Identifier.of(SpellbladesAndSuch.MOD_ID, "magus_firenova"));
            ...
            if(mob.getTarget() != null) {
                Vec3d vec31 = new Vec3d(mob.getTarget().getX() - this.mob.getX(), mob.getTarget().getY() - this.mob.getY(), mob.getTarget().getZ() - this.mob.getZ());
