...
import static com.cleannrooster.hexblade.entity.Magus.DOWN2;
...
public class MagusAI {
        ...
        private static void initCoreActivity(Magus Magus, Brain<Magus> brain) {
            brain.setTaskList(Activity.CORE, 0, ImmutableList.of(new LookAroundTask(45, 90),FindWalkTargetTask.create(0.6F), StrollTask.create(1.0F),   OpenDoorsTask.create(),  ForgetAngryAtTargetTask.create()));
        }
