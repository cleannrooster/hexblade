...
public class Hexblade extends HorizontalFacingBlock {
    ...
    public void appendTooltip(ItemStack stack, Item.TooltipContext context, List<Text> tooltip, TooltipType options) {
        tooltip.add(Text.translatable("Place to ward off Hexblade invasions in a 64 block radius, "));
        tooltip.add(Text.translatable("or carry to prevent yourself from being Hexed."));
        tooltip.add(Text.translatable("Right Click on air to create a Hexblade Portal you can right click on with this sword to enter the Glass Ocean"));
